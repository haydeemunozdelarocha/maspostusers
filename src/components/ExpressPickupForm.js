...
class ExpressPickupForm extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            packageAuthInfo: {
    ...
    render() {
        ...
        return (
            <form className="form">
                ...
                <input name="button" type="button" onClick={()=> this.handleSubmit()} value="Programar" className="btn btn-default form-button" />
            </form>
        );
    }
}

export default ExpressPickupForm;
